...
const ProtocolType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'Ping', '2': 1},
    const {'1': 'Pong', '2': 2},
    const {'1': 'RegDevice', '2': 3},
  ],
};

/// Descriptor for `ProtocolType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List protocolTypeDescriptor = $convert.base64Decode('CgxQcm90b2NvbFR5cGUSDQoJVW5kZWZpbmVkEAASCAoEUGluZxABEggKBFBvbmcQAhINCglSZWdEZXZpY2UQAw==');
